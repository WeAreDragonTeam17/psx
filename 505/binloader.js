...
var exploit = function() {
   ...
   alert("Đang chờ dữ liệu tải... Hãy gửi dữ liệu bằng địa chỉ IP của PS4 và cổng 9020");
   msgs2.innerHTML="<h1 style='font-size:30px;'>Trình tải tệp nhị phân đã khởi chạy ✔</h1>";
};
